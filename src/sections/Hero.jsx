  ...
  return (
    <section className='w-full min-h-screen flex flex-col relative' id='home'>
      ...
      <div className='w-full mx-auto flex flex-col sm:mt-26 mt-20 c-space gap-3'>
        <p className='sm:text-3xl text-2xl font-medium text-white text-center font-generalsans'>Hi, I am Aakash <span className='waving-hand'>👋</span></p>
      ...
      <div className='absolute bottom-7 left-0 right-0 w-full z-10 c-space'>
        <a href="#about" target='_blank' className='w-fit'>
          <Button name="View Resume" isBeam containerClass="sm:w-fit w-full sm:min-w-96 mx-auto" />
        </a>
      </div>
    </section>
  )
